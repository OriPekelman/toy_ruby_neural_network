...
GGUF_PATH  = "data/qwen25-1.5b-f32.gguf"
...
puts "[openai_api_qwen25_1.5b] realising KV cache (MAX_T=" + MAX_T.to_s + ")..."
...
puts "[openai_api_qwen25_1.5b] loading weights (direct GGUF→FFI)..."
