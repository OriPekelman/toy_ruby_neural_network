...
GGUF_PATH  = "data/qwen25-7b-q8_0.gguf"
...
puts "[openai_api_qwen25_7b_q8] realising KV cache (MAX_T=" + MAX_T.to_s + ")..."
...
puts "[openai_api_qwen25_7b_q8] loading weights (direct GGUF→FFI)..."
