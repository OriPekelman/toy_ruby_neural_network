...
puts "  token_embed.flat[0]="
puts model.token_embed.flat[0]
puts "  token_embed.flat[7]="
puts model.token_embed.flat[7]
...
puts "  grads.token_embed.flat[0] (after first backward):"
